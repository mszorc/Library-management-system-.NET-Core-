...
namespace SBDlibrary.ViewModel
{
    public class InputModelRegister
    {
        ...
        [StringLength(50, ErrorMessage = "Imię musi mieć co najmniej 2 oraz maksymalnie 20 znaków długości.", MinimumLength = 2)]
        [Display(Name = "Imię")]
        public string FirstName { get; set; }

        [Required(ErrorMessage = "Pole 'Nazwisko' jest wymagane.")]
        [DataType(DataType.Text)]
        [StringLength(50, ErrorMessage = "Nazwisko musi mieć co najmniej 2 oraz maksymalnie 20 znaków długości.", MinimumLength = 2)]
